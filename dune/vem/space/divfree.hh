...
namespace Dune
{
  namespace Vem
  {
    ...
    protected:
      virtual void finalize(const Std::vector<Std::vector<typename BaseType::ElementSeedType> > &entitySeeds, unsigned int agglomerate) override
      {
        //////////////////////////////////////////////////////////////////////////
        ...
        DynamicMatrix<DomainFieldType> HpValue, HpValueInv;
