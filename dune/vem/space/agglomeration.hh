...
namespace Dune {
    ...
    namespace Vem {
              ...
              unsigned int start, unsigned int end )
        {
          ...
          const std::size_t baseRangeDimension = Traits :: baseRangeDimension;
          assert( InnerTestSpace::RangeType::dimension == baseRangeDimension );
          assert( EdgeTestSpace::RangeType::dimension == baseRangeDimension );
